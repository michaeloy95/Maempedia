...
{
    public class ProfilePictureRegisterPageViewModel : BaseViewModel
    {
        ...
        private async void GoNext()
        {
            ...
            await this.NavigationService.NavigateTo(typeof(ContactRegisterPage), new object[] { this.CurOwner, this.ImageAspectRatio });
